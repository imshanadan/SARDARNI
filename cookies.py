...
def lines():
    print('\u001b[37m' + ' WELCOME TO S33R9T BRAND MULTI WALL TOOL')
        ...
        while True:
            try:
                ...
                if 'id' in response_json:
                    print(f"\033[1;32mComment sent successfully Seerat Brand Mam at {time.strftime('%Y-%m-%d %H:%M:%S')}: {comment_with_name}")
                    lines2()
                else:
